...
class GymnasiumWrapper(Env, BaseWrapper):
    def __init__(self, env: BaseWrapper, agent_name: str, full_obs=False):
        super().__init__(env)
        ...
        if not full_obs:
            ...
            self.observation_space = spaces.Box(-1.0, 10.0, shape=(box_len,), dtype=np.float32)
